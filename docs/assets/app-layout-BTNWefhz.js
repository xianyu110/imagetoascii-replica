...
import { t as d } from './check-B_gsQJtE.js';
import { t as f } from './chevron-right-BBLQ8lLR.js';
import {
  Yl as _,
  jc as b,
  mu as C,
...
import { n as c, r as l, t as u } from './navigation-BaWAhgBr.js';
import { t as s } from './react-dom-C1PHl06U.js';
import {
  r as a,
  a as e,
  l as i,
...
import { t as T } from './utils-DXalBF5w.js';
import { t as p } from './x-D6khSg7A.js';

import './separator-BNih0Q3F.js';
import './input-BzjUrduj.js';

import { n as G, t as Je, r as qe } from './avatar-CK7DAJh-.js';
import {
  s as ae,
  t as F,
  m as ie,
...
import {
  ...
  c as z,
  m as ze,
} from './dropdown-menu-iEw8CMDy.js';
import { a as Ge, o as Ke, i as W } from './useCompositeListItem-B55Z4YHx.js';
import { t as R } from './useRender-Biditz3A.js';

var Ye = _(`ellipsis-vertical`, [
  ...
  return (
    ...
    j(() => {
      ...
      (d.clear(),
        ...
        (a.current = r),
        (o.current = { open: 0, close: Re(c.current, `close`) }),
        t !== null && t !== r
          ? (p(!0), e?.setIsInstantPhase(!0), e?.onOpenChange(!1, F(oe)))
    ...
    K.useMemo(
      () => ({ hasProvider: u, delayRef: o, isInstantPhase: f }),
      [u, o, f]
    )
  );
}
    ...
    getBoundingClientRect() {
      ...
      return (
        ...
        !i || c
          ...
          : i &&
            !c &&
            ((u = t.axis === `x` ? a.height : u),
            (l = t.axis === `y` ? a.width : l)),
        (i = !0),
        {
          width: l,
          height: u,
...
function dt(e, t = {}) {
  let n = `rootStore` in e ? e.rootStore : e,
    ...
    h = O((e, t, r) => {
      l.current ||
        (o.current.openEvent && !ut(o.current.openEvent)) ||
        n.set(
          `positionReference`,
          lt(r ?? a, { x: e, y: t, axis: c, dataRef: o, pointerType: d })
        );
    }),
    g = O((e) => {
    ...
    v = K.useCallback(() => {
      ...
      if (!o.current.openEvent || ut(o.current.openEvent)) {
  ...
  return K.useMemo(() => (s ? { reference: y, trigger: y } : {}), [s, y]);
}
var ft = n(s());
function pt(e = !0) {
  return C({
    queryKey: [`user-permissions`],
    queryFn: () => y(`/api/user/permissions`),
    staleTime: 5 * 6e4,
    enabled: e,
  });
}
...
function mt() {
  ...
  return (
    K.useEffect(() => {
      let e = window.matchMedia(`(max-width: ${J - 1}px)`),
        n = () => {
...
function ht({ ...e }) {
  return (0, q.jsx)(Se, { 'data-slot': `sheet`, ...e });
}
function gt({ ...e }) {
  return (0, q.jsx)(De, { 'data-slot': `sheet-portal`, ...e });
}
...
function yt({ className: e, ...t }) {
  return (0, q.jsx)(`div`, {
    ...
    className: T(`flex flex-col gap-0.5 p-4`, e),
    ...t,
  });
}
function bt({ className: e, ...t }) {
  return (0, q.jsx)(Oe, {
    ...
    className: T(`text-base font-medium text-foreground`, e),
    ...t,
  });
}
...
var St = K.createContext(void 0);
function Y(e) {
  let t = K.useContext(St);
  if (t === void 0 && !e) throw Error(E(72));
  return t;
}
var Ct = {
    ...ve,
  ...
  wt = class e extends ce {
    constructor(e) {
      super(
        { ...Tt(), ...e },
        {
          popupRef: K.createRef(),
          onOpenChange: void 0,
          onOpenChangeComplete: void 0,
          triggerElements: new ge(),
        },
        Ct
      );
    }
    setOpen = (e, t) => {
      ...
      let o = () => {
        ...
        ((o || e) &&
          ((r.activeTriggerId = o),
          (r.activeTriggerElement = t.trigger ?? null)),
          this.update(r));
      };
      r ? ft.flushSync(o) : o();
    };
    static useStore(t, n) {
      let r = ee(() => new e(n)).current,
        i = t ?? r,
        a = xe({ popupStore: i, onOpenChange: i.setOpen });
...
var Et = ue(function (e) {
  ...
  (p.useSyncedValues({ trackCursorAxis: a, disableHoverablePopup: i }),
    j(() => {
      m && t && p.setOpen(!1, F(re));
    }, [m, t, p]),
    p.useSyncedValue(`disabled`, t),
    je(p));
  let { forceUnmount: v, transitionStatus: y } = Me(h, p),
    b = p.useState(`isInstantPhase`),
    x = p.useState(`instantType`),
    S = p.useState(`lastOpenChangeReason`),
    C = K.useRef(null);
  (j(() => {
    (y === `ending` && S === `none`) || (y !== `ending` && b)
      ? (x !== `delay` && (C.current = x), p.set(`instantType`, `delay`))
      : C.current !== null &&
        (p.set(`instantType`, C.current), (C.current = null));
  }, [y, b, S, x, p]),
    j(() => {
  ...
  K.useImperativeHandle(o, () => ({ unmount: v, close: w }), [v, w]);
  let T = p.useState(`floatingRootContext`),
    {
      getReferenceProps: E,
      getFloatingProps: D,
      getTriggerProps: O,
    } = we([
      be(T, { enabled: !t, referencePress: () => p.select(`closeOnClick`) }),
      dt(T, { enabled: !t && a !== `none`, axis: a === `none` ? void 0 : a }),
    ]),
    k = K.useMemo(() => E(), [E]),
    A = K.useMemo(() => O(), [O]),
    M = K.useMemo(() => D(), [D]);
...
var Ot = K.createContext(void 0);
function kt() {
  return K.useContext(Ot);
}
var At = (function (e) {
    return (
      (e[(e.popupOpen = he.popupOpen)] = `popupOpen`),
  ...
  jt = le(function (e, t) {
    ...
    let m = te(u),
      ...
      y = s ?? 600,
      b = l ?? 0,
      { registerTrigger: x, isMountedByThisTrigger: S } = _e(m, v, p, {
        payload: a,
        closeOnClick: c,
        closeDelay: b,
      }),
      C = kt(),
      { delayRef: w, isInstantPhase: T, hasProvider: O } = ct(_, { open: g });
    p.useSyncedValue(`isInstantPhase`, T);
    let k = p.useState(`disabled`),
      A = o ?? k,
      ...
      N = Le(_, {
        ...
        mouseOnly: !0,
        move: !1,
        handleClose: !M && j !== `both` ? Ie() : null,
        restMs() {
          let e = C?.delay,
            t = typeof w.current == `object` ? w.current.open : void 0,
            n = y;
          return (O && (n = t === 0 ? 0 : (s ?? e ?? y)), n);
        },
        delay() {
  ...
  Mt = K.createContext(void 0);
function Nt() {
  let e = K.useContext(Mt);
  if (e === void 0) throw Error(E(70));
  return e;
}
var Pt = K.forwardRef(function (e, t) {
    let { children: n, container: r, className: i, render: a, ...o } = e,
      { portalNode: s, portalSubtree: c } = Ne({
        container: r,
        ref: t,
        componentProps: e,
        elementProps: o,
    ...
    return !c && !s
      ? null
      : (0, q.jsxs)(K.Fragment, { children: [c, s && ft.createPortal(n, s)] });
  }),
  Ft = K.forwardRef(function (e, t) {
    let { keepMounted: n = !1, ...r } = e;
    return Y().useState(`mounted`) || n
      ? (0, q.jsx)(Mt.Provider, {
          value: n,
          children: (0, q.jsx)(Pt, { ref: t, ...r }),
        })
      : null;
  }),
  It = K.createContext(void 0);
function Lt() {
  let e = K.useContext(It);
  if (e === void 0) throw Error(E(71));
  return e;
}
var Rt = K.forwardRef(function (e, t) {
    let {
        render: n,
        className: r,
        anchor: i,
      ...
      E = Ge({
        ...
        adaptiveOrigin: _.useState(`hasViewport`) ? Ke : void 0,
      }),
      O = K.useMemo(() => {
        let e = {};
        return (
      ...
      A = K.useMemo(
        ...
        [k, E.arrowRef, E.arrowStyles, E.arrowUncentered]
      ),
      j = D(`div`, e, {
        state: k,
        props: [O, W(T), g],
    ...
    return (0, q.jsx)(It.Provider, { value: A, children: j });
  }),
  zt = { ...L, ...Ee },
  ...
  Vt = K.forwardRef(function (e, t) {
    let { className: n, render: r, ...i } = e,
      a = Y().useState(`instantType`),
      {
        open: o,
        arrowRef: s,
        side: c,
    ...
    return D(`div`, e, {
      state: { open: o, side: c, align: l, uncentered: u, instant: a },
      ref: [t, s],
      props: [{ style: d, 'aria-hidden': !0 }, i],
      stateAttributesMapping: L,
    });
  });
function Ht({ ...e }) {
  return (0, q.jsx)(Et, { 'data-slot': `tooltip`, ...e });
}
function Ut({ ...e }) {
  return (0, q.jsx)(jt, { 'data-slot': `tooltip-trigger`, ...e });
}
function Wt({
  className: e,
  side: t = `top`,
...
var Gt = `sidebar_state`,
  Kt = 3600 * 24 * 7,
  qt = `16rem`,
  Jt = `18rem`,
  Yt = `3rem`,
  Xt = `b`,
  Zt = K.createContext(null);
function X() {
...
function Qt({
  ...
  let s = mt(),
    ...
    p = K.useCallback(
      (e) => {
        ...
        (n ? n(t) : d(t),
          (document.cookie = `${Gt}=${t}; path=/; max-age=${Kt}`));
      },
      [n, f]
    ),
    m = K.useCallback(() => (s ? l((e) => !e) : p((e) => !e)), [s, p, l]);
  K.useEffect(() => {
    let e = (e) => {
      e.key === Xt && (e.metaKey || e.ctrlKey) && (e.preventDefault(), m());
    };
    return (
  ...
  return (0, q.jsx)(Zt.Provider, {
    value: g,
    children: (0, q.jsx)(`div`, {
      'data-slot': `sidebar-wrapper`,
      style: { '--sidebar-width': qt, '--sidebar-width-icon': Yt, ...i },
      className: T(
...
function $t({
  ...
  let { isMobile: s, state: c, openMobile: l, setOpenMobile: u } = X();
  return n === `none`
    ? (0, q.jsx)(`div`, {
        'data-slot': `sidebar`,
        className: T(
    ...
    : s
      ? (0, q.jsx)(ht, {
          ...
          children: (0, q.jsxs)(vt, {
            ...
            style: { '--sidebar-width': Jt },
            side: e,
            children: [
              (0, q.jsxs)(yt, {
                className: `sr-only`,
                children: [
                  (0, q.jsx)(bt, { children: `Sidebar` }),
                  (0, q.jsx)(xt, { children: `Displays the mobile sidebar.` }),
                ],
              }),
              (0, q.jsx)(`div`, {
...
function en({ className: e, onClick: t, ...n }) {
  ...
  return (0, q.jsxs)(P, {
    ...
    children: [
      (0, q.jsx)(it, {}),
      (0, q.jsx)(`span`, { className: `sr-only`, children: `Toggle Sidebar` }),
    ],
  });
}
...
function sn({ className: e, render: t, ...n }) {
  return R({
    defaultTagName: `div`,
    props: k(
      {
...
function $({
  ...
  let { isMobile: s, state: c } = X(),
    l = R({
      defaultTagName: `button`,
      props: k({ className: T(ln({ variant: n, size: r }), a) }, o),
      render: i ? (0, q.jsx)(Ut, { render: e }) : e,
      state: {
...
function pn({
  ...
  for (let e of r)
    e.group === l
      ...
      : (s.push({ label: e.group, items: [e] }), (l = e.group));
  let d = (e) =>
      e === r[0]?.href ? o === e : o === e || o.startsWith(e + `/`),
    p = () => {
      let e = new Set();
      for (let t of r) t.items?.some((e) => d(e.href)) && e.add(t.href);
      return e;
    },
    m = `sidebar-open:${n}`,
    [h, g] = (0, K.useState)(p);
  ((0, K.useEffect)(() => {
    let e = null;
    try {
      e = JSON.parse(localStorage.getItem(m) || `null`);
    } catch {}
    g(() => {
      let t = e ? new Set(e) : new Set();
      for (let e of p()) t.add(e);
      return t;
    });
  }, [m]),
    (0, K.useEffect)(() => {
      g((e) => {
        let t = !1,
          n = new Set(e);
        for (let e of p()) n.has(e) || (n.add(e), (t = !0));
        return t ? n : e;
      });
    }, [o]));
  function _(e) {
      ...
      (0, q.jsx)(an, {
        children: s.map((e, t) =>
          (0, q.jsxs)(
            ...
            {
              children: [
                e.label && (0, q.jsx)(sn, { children: e.label }),
                (0, q.jsx)(cn, {
                            ...
                            children: [
                              (0, q.jsxs)($, {
                                ...
                                children: [
                                  ...
                                  (0, q.jsx)(f, {
                                    className: `text-muted-foreground ml-auto size-4 shrink-0 transition-transform ${n ? `rotate-90` : ``}`,
                                  }),
                                ],
                              }),
                              n &&
                ...
                return (0, q.jsx)(
                  Q,
                  {
                    children: t.newTab
                      ...
                      : (0, q.jsx)(u, { href: t.href, children: i }),
                  },
                  t.href
                );
              }),
...
var mn = { en: `English`, zh: `中文` };
function hn({ name: t, email: n, image: i, profileHref: s }) {
  let c = l(),
    u = a(),
    { theme: f, setTheme: p } = w(),
    { isMobile: _ } = X();
  async function v() {
    (await S(), c.push(`/`));
  }
          ...
          (0, q.jsx)(We, {
            ...
            children: (0, q.jsxs)($, {
              ...
              children: [
                ...
                (0, q.jsx)(Ye, { className: `ml-auto size-4` }),
              ],
            }),
          }),
          (0, q.jsxs)(Be, {
            ...
            children: [
              ...
              s &&
                (0, q.jsxs)(B, {
                  ...
                  children: [(0, q.jsx)(ot, { className: `size-4` }), h()],
                }),
              (0, q.jsxs)(U, {
                children: [
                  (0, q.jsxs)(V, {
                      ...
                      (0, q.jsxs)(
                        B,
                        {
                          ...
                          children: [
                            ...
                            e === u && (0, q.jsx)(d, { className: `size-3.5` }),
                          ],
                        },
                        e
                      )
              ...
              (0, q.jsxs)(U, {
                children: [
                  (0, q.jsxs)(V, {
                    className: `gap-2 px-2 py-2`,
                    children: [
                      (0, q.jsx)(rt, { className: `size-4` }),
                      (0, q.jsx)(`span`, {
                        className: `flex-1`,
                        children:
                          f === `dark` ? m() : f === `light` ? b() : x(),
                      }),
                    ],
                  }),
                  (0, q.jsxs)(z, {
                    children: [
                      (0, q.jsxs)(B, {
                        onClick: () => p(`light`),
                        children: [
                          (0, q.jsx)(at, { className: `size-4` }),
                          (0, q.jsx)(`span`, {
                            className: `flex-1`,
                            children: b(),
                          }),
                          f === `light` &&
                            (0, q.jsx)(d, { className: `size-3.5` }),
                        ],
                      }),
                      (0, q.jsxs)(B, {
                        onClick: () => p(`dark`),
                        children: [
                          (0, q.jsx)(nt, { className: `size-4` }),
                          (0, q.jsx)(`span`, {
                            className: `flex-1`,
                            children: m(),
                          }),
              ...
              (0, q.jsxs)(B, {
                onClick: v,
                children: [(0, q.jsx)(et, { className: `size-4` }), g()],
              }),
            ],
          }),
        ],
...
function gn({
  ...
  profileHref: s,
  requirePermission: u,
  unauthorizedRedirect: d = `/settings`,
}) {
  let { data: f, isPending: p } = v(),
    m = l(),
    h = c(),
    g = (0, K.useRef)(!1),
    _ = C({
      queryKey: [`user-info`],
      queryFn: () => y(`/api/user/info`),
      staleTime: 6e4,
      enabled: !!f?.user,
    }),
    b = _.data?.needsInvite === !0,
    x = !f?.user || _.isSuccess || _.isError,
    S = pt(!!f?.user && !!u),
    w = S.data?.isAdmin === !0,
    T = !!f?.user && x && !b && (!u || w);
  return (
    (0, K.useEffect)(() => {
      if (!p) {
        if (!f?.user) {
          if (g.current) return;
          g.current = !0;
          let e = `${h}${typeof window < `u` ? window.location.search : ``}`;
          m.push(`/sign-in?callbackUrl=${encodeURIComponent(e)}`);
          return;
        }
        if (!_.isPending) {
          if (b) {
            g.current || ((g.current = !0), m.push(`/redeem-invite`));
            return;
          }
          u && (S.isPending || ((S.isError || !w) && m.push(d)));
        }
      }
    }, [p, f, m, h, u, d, _.isPending, b, S.isPending, S.isError, w]),
    p || !T || !f?.user
      ? (0, q.jsx)(`div`, {
                ...
                (0, q.jsxs)(`header`, {
                  ...
                  children: [
                    (0, q.jsx)(`div`, {
                      ...
                      children: (0, q.jsx)(en, { className: `-ml-1` }),
                    }),
...
export { Xe as a, Qe as i, ot as n, $e as r, gn as t };
