import { t as i, n as r } from './header-BlAGdRjK.js';
...
var h = [
  ...
  g = `ui-monospace, "SF Mono", Menlo, Monaco, "Courier New", monospace`;
function _(e, t, n, r) {
  let i = document.createElement(`canvas`),
    a = e.naturalHeight / e.naturalWidth,
    o = Math.max(1, Math.round(t * a * 0.45));
  ((i.width = t), (i.height = o));
  let s = i.getContext(`2d`, { willReadFrequently: !0 });
  if (!s) return ``;
  s.drawImage(e, 0, 0, t, o);
  let c = s.getImageData(0, 0, t, o).data,
    l = r ? [...n].reverse().join(``) : n,
    u = [];
  for (let e = 0; e < o; e += 1) {
    let n = ``;
    for (let r = 0; r < t; r += 1) {
      let i = (e * t + r) * 4,
        ...
        o = c[i + 1] ?? 0,
        s = c[i + 2] ?? 0,
        u = (c[i + 3] ?? 255) === 0 ? 255 : 0.299 * a + 0.587 * o + 0.114 * s,
        d = Math.min(l.length - 1, Math.floor((u / 255) * l.length));
      n += l[d] ?? ` `;
    }
    u.push(n.trimEnd());
  }
...
`),
  ...
  if (!n) return null;
  n.font = `14px ${g}`;
  let r = Math.max(...t.map((e) => n.measureText(e).width)),
    i = document.createElement(`canvas`);
  ((i.width = Math.ceil(r + 48)), (i.height = Math.ceil(t.length * 16 + 48)));
...
`).length
  ...
  function D(e = C, t = T, n = p, r = y) {
    e && (i(_(e, n, t.ramp, r)), s(``));
  }
  function O(e) {
    if (!e) return;
    if (!e.type.startsWith(`image/`)) {
      s(`Please choose an image file.`);
      return;
    }
    ...
    ((r.onload = () => {
      ...
      (r.onerror = () => {
        (URL.revokeObjectURL(t),
          s(`Could not read that image. Try another JPG, PNG, or WebP.`));
      }),
      (r.src = t));
  }
  async function k() {
  ...
  function A() {
    ...
    ((n.href = e),
      (n.download = `${t.replace(/\.[^.]+$/, ``) || `ascii-art`}.png`),
      n.click());
  }
  return (0, a.jsx)(`section`, {
    id: `tool`,
        ...
        (0, a.jsxs)(`div`, {
          ...
          children: [
            ...
            (0, a.jsx)(`p`, {
              ...
              children: `Upload a photo and the converter turns it into text art right in your browser. Free, no signup.`,
            }),
          ],
        }),
        (0, a.jsxs)(`div`, {
          ...
          children: [
            (0, a.jsx)(`input`, {
              ...
              className: `sr-only`,
              onChange: (e) => O(e.target.files?.[0]),
            }),
            (0, a.jsxs)(`button`, {
              type: `button`,
              className: `flex flex-col items-center justify-center`,
              style: {
                backgroundColor: c ? `#101816` : `#08080c`,
                padding: `40px 20px`,
                borderRadius: `8px`,
                border: `1px dashed ${c ? `rgba(51, 255, 51, 0.72)` : `rgba(255, 255, 255, 0.2)`}`,
                cursor: `pointer`,
                transition: `0.15s`,
                textAlign: `center`,
                minHeight: `150px`,
              ...
              onDragLeave: () => l(!1),
              onDrop: (e) => {
                (e.preventDefault(), l(!1), O(e.dataTransfer.files?.[0]));
              },
              children: [
                (0, a.jsxs)(`svg`, {
                  width: `34`,
                ...
                (0, a.jsx)(`span`, {
                  ...
                  children: `click to browse — JPG, PNG, GIF, WebP`,
                }),
              ],
            }),
            (0, a.jsxs)(`div`, {
                        ...
                        (0, a.jsx)(
                          `button`,
                          {
                            ...
                            style: {
                              ...
                              backgroundColor: t === d ? `#1d2a1d` : `#0d0d11`,
                              color:
                                t === d ? `#33ff33` : `rgba(255,255,255,0.62)`,
                              cursor: `pointer`,
                              fontFamily: g,
                            },
                            onClick: () => {
                      ...
                      children: [
                        (0, a.jsx)(`button`, {
                          ...
                          style: {
                            ...
                            borderRadius: `6px`,
                            border: `1px solid rgba(255,255,255,0.12)`,
                            backgroundColor: r ? `#101015` : `#08080c`,
                            color: r ? `#33ff33` : `rgba(255,255,255,0.3)`,
                            cursor: r ? `pointer` : `not-allowed`,
                            fontFamily: g,
                          },
                          children: x ? `Copied` : `Copy text`,
                        }),
                        (0, a.jsx)(`button`, {
                          type: `button`,
                          disabled: !r,
                          ...
                          style: {
                            ...
                            borderRadius: `6px`,
                            border: `none`,
                            backgroundColor: r ? `#ff9d00` : `#3a2b16`,
                            color: `#0a0a0c`,
                            cursor: r ? `pointer` : `not-allowed`,
                            fontFamily: g,
                          },
...
The conversion runs locally in your browser.`,
            ...
            o
              ? (0, a.jsx)(`p`, {
                  style: { margin: 0, color: `#ff9d00`, fontSize: `14px` },
                  children: o,
                })
              : null,
          ],
  ...
  return (0, a.jsxs)(`section`, {
    ...
    children: [
      ...
      (0, a.jsx)(`div`, {
        ...
        children: b.map((e) => (0, a.jsx)(S, { ...e }, e.slug)),
      }),
    ],
  });
}
