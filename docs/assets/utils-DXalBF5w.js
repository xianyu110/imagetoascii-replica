...
var n = (e, t) => {
  ...
  w = (e) => {
    ...
    if (t) {
      let e = t + x,
        n = r;
      r = (t) =>
        t.startsWith(e) ? n(t.slice(e.length)) : C(S, !1, t, void 0, !0);
    }
    if (n) {
      let e = r;
  ...
  De = O(() => {
    let e = A(`color`),
      ...
      N = () => [e, K, U],
      ie = () => [...y(), ve, he, { position: [K, U] }],
      ae = () => [`no-repeat`, { repeat: [``, `x`, `y`, `space`, `round`] }],
      oe = () => [`auto`, `cover`, `contain`, ye, de, { size: [K, U] }],
      P = () => [se, q, W],
      F = () => [``, `none`, `full`, l, K, U],
      B = () => [``, L, q, W],
    ...
    return {
      ...
      classGroups: {
        aspect: [{ aspect: [`auto`, `square`, I, U, K, h] }],
        container: [`container`],
        columns: [{ columns: [L, U, K, s] }],
        ...
        z: [{ z: [R, `auto`, K, U] }],
        basis: [{ basis: [I, `full`, `auto`, s, ...C()] }],
        'flex-direction': [
          { flex: [`row`, `row-reverse`, `col`, `col-reverse`] },
        ],
        'flex-wrap': [{ flex: [`nowrap`, `wrap`, `wrap-reverse`] }],
        flex: [{ flex: [L, I, `auto`, `initial`, `none`, U] }],
        grow: [{ grow: [``, L, K, U] }],
        shrink: [{ shrink: [``, L, K, U] }],
        order: [{ order: [R, `first`, `last`, `none`, K, U] }],
        ...
        'line-clamp': [{ 'line-clamp': [L, `none`, K, fe] }],
        leading: [{ leading: [a, ...C()] }],
        ...
        'underline-offset': [{ 'underline-offset': [L, `auto`, K, U] }],
        'text-transform': [
          `uppercase`,
          `lowercase`,
          `capitalize`,
        ...
        'outline-offset': [{ 'outline-offset': [L, K, U] }],
        'outline-w': [{ outline: [``, L, q, W] }],
        'outline-color': [{ outline: N() }],
        shadow: [{ shadow: [``, `none`, u, J, G] }],
        'shadow-color': [{ shadow: N() }],
        'inset-shadow': [{ 'inset-shadow': [`none`, ee, J, G] }],
        ...
        'text-shadow': [{ 'text-shadow': [`none`, d, J, G] }],
        'text-shadow-color': [{ 'text-shadow': N() }],
        opacity: [{ opacity: [L, K, U] }],
        'mix-blend': [
        ...
        blur: [{ blur: Y() }],
        brightness: [{ brightness: [L, K, U] }],
        contrast: [{ contrast: [L, K, U] }],
        'drop-shadow': [{ 'drop-shadow': [``, `none`, f, J, G] }],
        'drop-shadow-color': [{ 'drop-shadow': N() }],
        grayscale: [{ grayscale: [``, L, K, U] }],
        'hue-rotate': [{ 'hue-rotate': [L, K, U] }],
        invert: [{ invert: [``, L, K, U] }],
        saturate: [{ saturate: [L, K, U] }],
        sepia: [{ sepia: [``, L, K, U] }],
        'backdrop-filter': [{ 'backdrop-filter': [``, `none`, K, U] }],
        'backdrop-blur': [{ 'backdrop-blur': Y() }],
        'backdrop-brightness': [{ 'backdrop-brightness': [L, K, U] }],
        'backdrop-contrast': [{ 'backdrop-contrast': [L, K, U] }],
        'backdrop-grayscale': [{ 'backdrop-grayscale': [``, L, K, U] }],
        'backdrop-hue-rotate': [{ 'backdrop-hue-rotate': [L, K, U] }],
        'backdrop-invert': [{ 'backdrop-invert': [``, L, K, U] }],
        'backdrop-opacity': [{ 'backdrop-opacity': [L, K, U] }],
        'backdrop-saturate': [{ 'backdrop-saturate': [L, K, U] }],
        'backdrop-sepia': [{ 'backdrop-sepia': [``, L, K, U] }],
        ...
        duration: [{ duration: [L, `initial`, K, U] }],
        ease: [{ ease: [`linear`, `initial`, g, K, U] }],
        delay: [{ delay: [L, K, U] }],
        animate: [{ animate: [`none`, _, K, U] }],
