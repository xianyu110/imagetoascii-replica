...
function a(e, t) {
  typeof t != `string` && (t = a.defaultChars);
  let n = i(t);
...
function c(e, t, n) {
  (typeof t != `string` && ((n = t), (t = c.defaultChars)),
    n === void 0 && (n = !0));
  let r = s(t),
    i = ``;
...
((c.defaultChars = `;/?:@&=+$,-_.!~*'()#`), (c.componentChars = `-_.!~*'()`));
function l(e) {
  let t = ``;
  return (
    (t += e.protocol || ``),
...
((u.prototype.parse = function (e, t) {
  ...
  if (
    ...
    (t || o || a.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
      ((i = a.substr(0, 2) === `//`),
      i && !(o && y[o]) && ((a = a.substr(2)), (this.slashes = !0))),
    !y[o] && (i || (o && !ee[o])))
  ) {
    let e = -1;
    for (let t = 0; t < h.length; t++)
      ((r = a.indexOf(h[t])), r !== -1 && (e === -1 || r < e) && (e = r));
    let t, n;
    ((n = e === -1 ? a.lastIndexOf(`@`) : a.lastIndexOf(`@`, e)),
      n !== -1 && ((t = a.slice(0, n)), (a = a.slice(n + 1)), (this.auth = t)),
      (e = -1));
    for (let t = 0; t < m.length; t++)
      ((r = a.indexOf(m[t])), r !== -1 && (e === -1 || r < e) && (e = r));
    ...
    (this.hostname.length > g && (this.hostname = ``),
  ...
  return (
    ...
    a && (this.pathname = a),
    ee[n] && this.hostname && !this.pathname && (this.pathname = ``),
    this
  );
}),
...
function fe(e) {
  return (e >= 55296 && e <= 57343) || e > 1114111 ? 65533 : (ue.get(e) ?? e);
}
var S;
(function (e) {
  ((e[(e.NUM = 35)] = `NUM`),
...
function he(e) {
  return (
    (e >= S.UPPER_A && e <= S.UPPER_F) || (e >= S.LOWER_A && e <= S.LOWER_F)
  );
}
function ge(e) {
  return (
    (e >= S.UPPER_A && e <= S.UPPER_Z) ||
    (e >= S.LOWER_A && e <= S.LOWER_Z) ||
    me(e)
  );
}
function _e(e) {
  return e === S.EQUALS || ge(e);
}
var w;
(function (e) {
...
var ve = class {
  ...
  write(e, t) {
    switch (this.state) {
      case w.EntityStart:
        return e.charCodeAt(t) === S.NUM
          ? ((this.state = w.NumericStart),
            (this.consumed += 1),
            this.stateNumericStart(e, t + 1))
          : ((this.state = w.NamedEntity), this.stateNamedEntity(e, t));
      case w.NumericStart:
  ...
  stateNumericStart(e, t) {
    return t >= e.length
      ? -1
      : (e.charCodeAt(t) | pe) === S.LOWER_X
        ? ((this.state = w.NumericHex),
          (this.consumed += 1),
  ...
  addToNumericResult(e, t, n, r) {
    if (t !== n) {
      let i = n - t;
      ((this.result = this.result * r ** +i + parseInt(e.substr(t, i), r)),
        (this.consumed += i));
    }
  }
  stateNumericHex(e, t) {
  ...
  emitNumericEntity(e, t) {
    ...
    return (
      this.emitCodePoint(fe(this.result), this.consumed),
      this.errors &&
  ...
  stateNamedEntity(e, t) {
    let { decodeTree: n } = this,
      r = n[this.treeIndex],
      i = (r & C.VALUE_LENGTH) >> 14;
    for (; t < e.length; t++, this.excess++) {
      let a = e.charCodeAt(t);
      if (
        ((this.treeIndex = be(n, r, this.treeIndex + Math.max(1, i), a)),
        this.treeIndex < 0)
      )
        return this.result === 0 ||
          (this.decodeMode === T.Attribute && (i === 0 || _e(a)))
          ? 0
          : this.emitNotTerminatedNamedEntity();
      if (
        ((r = n[this.treeIndex]), (i = (r & C.VALUE_LENGTH) >> 14), i !== 0)
      ) {
        if (a === S.SEMI)
  ...
  emitNamedEntityData(e, t, n) {
    ...
    return (
      this.emitCodePoint(t === 1 ? r[e] & ~C.VALUE_LENGTH : r[e + 1], n),
    ...
    switch (this.state) {
      case w.NamedEntity:
        return this.result !== 0 &&
          (this.decodeMode !== T.Attribute || this.result === this.treeIndex)
          ? this.emitNotTerminatedNamedEntity()
          : 0;
      case w.NumericDecimal:
...
var xe = ye(ce);
ye(le);
function Se(e, t = T.Legacy) {
  return xe(e, t);
}
function Ce(e) {
  return xe(e, T.Strict);
}
var we = t({
  arrayReplaceAt: () => ke,
  asciiTrim: () => Ge,
...
var je = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
  Me = RegExp(je.source + `|&([a-z#][a-z0-9]{1,31});`, `gi`),
...
function Fe(e) {
  return e.indexOf(`\\`) < 0 ? e : e.replace(je, `$1`);
}
function O(e) {
  return e.indexOf(`\\`) < 0 && e.indexOf(`&`) < 0
    ? e
    : e.replace(Me, function (e, t, n) {
        return t || Pe(e, n);
      });
}
var Ie = /[&<>"]/,
...
function k(e) {
  return Ie.test(e) ? e.replace(Le, ze) : e;
}
var Be = /[.?*+^$[\]\\(){}|-]/g;
function Ve(e) {
  return e.replace(Be, `\\$&`);
...
function Je(e, t, n) {
  ...
  for (
    ;
    i < n && ((r = e.charCodeAt(i)), !(r === 32 || r < 32 || r === 127));
  ) {
    if (r === 92 && i + 1 < n) {
  ...
  return t === i || o !== 0
    ? a
    : ((a.str = O(e.slice(t, i))), (a.pos = i), (a.ok = !0), a);
}
function Ye(e, t, n, r) {
  let i,
    a = t,
  ...
  for (; a < n; ) {
    if (((i = e.charCodeAt(a)), i === o.marker))
      return ((o.pos = a + 1), (o.str += O(e.slice(t, a))), (o.ok = !0), o);
    if (i === 40 && o.marker === 41) return o;
    (i === 92 && a + 1 < n && a++, a++);
  }
  return ((o.can_continue = !0), (o.str += O(e.slice(t, a))), o);
}
var Xe = t({
  ...
  P = {};
((P.code_inline = function (e, t, n, r, i) {
  let a = e[t];
  return `<code` + i.renderAttrs(a) + `>` + k(a.content) + `</code>`;
}),
  (P.code_block = function (e, t, n, r, i) {
    let a = e[t];
    return (
      `<pre` +
      i.renderAttrs(a) +
...
`
  ...
  (P.fence = function (e, t, n, r, i) {
    let a = e[t],
      o = a.info ? O(a.info).trim() : ``,
      s = ``,
      c = ``;
    if (o) {
      let e = o.split(/(\s+)/g);
    ...
    let l;
    if (
      ((l = (n.highlight && n.highlight(a.content, s, c)) || k(a.content)),
      l.indexOf(`<pre`) === 0)
    )
      return (
        l +
...
`
    ...
    if (o) {
      ...
      e < 0
        ...
        : ((t[e] = t[e].slice()), (t[e][1] += ` ` + n.langPrefix + s));
      let r = { attrs: t };
      return `<pre><code${i.renderAttrs(r)}>${l}</code></pre>\n`;
    }
    return `<pre><code${i.renderAttrs(a)}>${l}</code></pre>\n`;
  }),
  (P.image = function (e, t, n, r, i) {
    let a = e[t];
    return (
...
`;
  ...
  (P.text = function (e, t) {
    return k(e[t].content);
  }),
  (P.html_block = function (e, t) {
    return e[t].content;
  }),
  (P.html_inline = function (e, t) {
    return e[t].content;
  }));
function F() {
  this.rules = E({}, P);
...
((F.prototype.renderAttrs = function (e) {
  ...
  for (r = ``, t = 0, n = e.attrs.length; t < n; t++)
    r += ` ` + k(e.attrs[t][0]) + `="` + k(e.attrs[t][1]) + `"`;
  return r;
}),
  (F.prototype.renderToken = function (e, t, n) {
    let r = e[t],
      i = ``;
    if (r.hidden) return ``;
    (r.block &&
...
`
  ...
  (F.prototype.renderInline = function (e, t, n) {
    let r = ``,
      i = this.rules;
  ...
  (F.prototype.renderInlineAsText = function (e, t, n) {
    let r = ``;
  ...
  if (e.md.options.linkify)
    for (let n = 0, r = t.length; n < r; n++) {
      ...
      for (let a = r.length - 1; a >= 0; a--) {
        ...
        if (
          (o.type === `html_inline` &&
            (rt(o.content) && i > 0 && i--, it(o.content) && i++),
...
function dt(e) {
  ...
  for (let n = e.length - 1; n >= 0; n--) {
    let r = e[n];
    (r.type === `text` && !t && (r.content = r.content.replace(ct, ut)),
  ...
  if (e.md.options.typographer)
    for (t = e.tokens.length - 1; t >= 0; t--)
      e.tokens[t].type === `inline` &&
        (st.test(e.tokens[t].content) && dt(e.tokens[t].children),
        ot.test(e.tokens[t].content) && ft(e.tokens[t].children));
}
var mt = /['"]/,
  ht = /['"]/g,
  gt = `’`;
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    OUTER: for (; l < u; ) {
      ...
      if (o.index - 1 >= 0) m = c.charCodeAt(o.index - 1);
        ...
        for (
          n = a - 1;
          n >= 0 && !(e[n].type === `softbreak` || e[n].type === `hardbreak`);
          n--
        )
          if (e[n].content) {
      ...
      if (l < u) h = c.charCodeAt(l);
        ...
        for (
          n = a + 1;
          n < e.length &&
          !(e[n].type === `softbreak` || e[n].type === `hardbreak`);
          n++
        )
          if (e[n].content) {
      ...
      d
        ? r.push({ token: a, pos: o.index, single: p, level: s })
        : f && p && R(i, a, o.index, gt);
    }
  }
...
function yt(e) {
  if (e.md.options.typographer)
    for (let t = e.tokens.length - 1; t >= 0; t--)
      e.tokens[t].type !== `inline` ||
        !mt.test(e.tokens[t].content) ||
        vt(e.tokens[t].children, e);
}
function bt(e) {
  let t,
    n,
...
((z.prototype.push = function (e, t, n) {
  ...
  (z.prototype.skipSpaces = function (e) {
    for (let t = this.src.length; e < t && A(this.src.charCodeAt(e)); e++);
    return e;
  }),
  ...
  (z.prototype.getLines = function (e, t, n, r) {
    ...
    for (let a = 0, o = e; o < t; o++, a++) {
      let e = 0,
        ...
        l;
      for (
        l = o + 1 < t || r ? this.eMarks[o] + 1 : this.eMarks[o];
        c < l && e < n;
      ) {
        let t = this.src.charCodeAt(c);
        if (A(t)) t === 9 ? (e += 4 - ((e + this.bsCount[o]) % 4)) : e++;
...
function Et(e, t, n, r) {
  ...
  if ((s !== 124 && s !== 45 && s !== 58 && !A(s)) || (o === 45 && A(s)))
    return !1;
  for (; a < e.eMarks[i]; ) {
    let t = e.src.charCodeAt(a);
    if (t !== 124 && t !== 45 && t !== 58 && !A(t)) return !1;
    a++;
  }
  let c = wt(e, t + 1),
    l = c.split(`|`),
  ...
  if (
    ((c = wt(e, t).trim()),
    c.indexOf(`|`) === -1 || e.sCount[t] - e.blkIndent >= 4)
  )
    return !1;
  ((l = Tt(c)),
    ...
    if (e.src.charCodeAt(i++) === 62 && !t) {
      ...
      e.src.charCodeAt(i) === 32
        ...
        : e.src.charCodeAt(i) === 9
          ? ((n = !0),
            (e.bsCount[m] + t) % 4 == 3 ? (i++, t++, (r = !1)) : (r = !0))
          : (n = !1);
      let o = t;
      for (s.push(e.bMarks[m]), e.bMarks[m] = i; i < a; ) {
        let t = e.src.charCodeAt(i);
        if (A(t)) t === 9 ? (o += 4 - ((o + e.bsCount[m] + +!!r) % 4)) : o++;
        else break;
        i++;
      }
      ((p = i >= a),
...
function jt(e, t) {
  ...
  return (i !== 42 && i !== 45 && i !== 43) ||
    (r < n && !A(e.src.charCodeAt(r)))
    ? -1
    : r;
}
function Mt(e, t) {
  ...
  return i < r && ((a = e.src.charCodeAt(i)), !A(a)) ? -1 : i;
}
function Nt(e, t) {
  let n = e.level + 2;
...
function Ft(e, t, n, r) {
  ...
  for (; h.can_continue; ) {
    ...
    ((c += t),
      ...
      (a = c.length),
      o++,
      (h = e.md.helpers.parseLinkTitle(c, i, a, h)));
  }
  let g;
  for (
    i < a && m !== i && h.ok
      ? ((g = h.str), (i = h.pos))
      : ((g = ``), (i = f), (o = p));
    i < a && A(c.charCodeAt(i));
  )
    i++;
  if (i < a && c.charCodeAt(i) !== 10 && g)
    for (g = ``, i = f, o = p; i < a && A(c.charCodeAt(i)); ) i++;
  ...
  return _
    ? r
      ...
      : (e.env.references === void 0 && (e.env.references = {}),
        e.env.references[_] === void 0 &&
          (e.env.references[_] = { title: g, href: d }),
        (e.line = o),
        !0)
    : !1;
}
var It =
  ...
  B = [
    ...
    [/^<![A-Z]/, />/, !0],
    [/^<!\[CDATA\[/, /\]\]>/, !0],
    [RegExp(`^</?(` + It.join(`|`) + `)(?=(\\s|/?>|$))`, `i`), /^$/, !0],
    [RegExp(Rt.source + `\\s*$`), /^$/, !1],
  ];
function zt(e, t, n, r) {
  let i = e.bMarks[t] + e.tShift[t],
    a = e.eMarks[t];
  ...
  for (; s < n && !e.isEmpty(s); s++) {
    ...
    if (e.sCount[s] >= e.blkIndent) {
      ...
      if (
        ...
        (o === 45 || o === 61) &&
          ((t = e.skipChars(t, o)), (t = e.skipSpaces(t)), t >= n))
      ) {
        a = o === 61 ? 1 : 2;
        break;
      }
...
var V = [
  ...
  [`list`, Pt, [`paragraph`, `reference`, `blockquote`]],
  [`reference`, Ft],
...
function H() {
  ...
  for (let e = 0; e < V.length; e++)
    this.ruler.push(V[e][0], V[e][1], { alt: (V[e][2] || []).slice() });
}
((H.prototype.tokenize = function (e, t, n) {
  ...
  (H.prototype.parse = function (e, t, n, r) {
    if (!e) return;
...
function qt(e, t) {
  ...
  for (n++; n < i && A(e.src.charCodeAt(n)); ) n++;
  return ((e.pos = n), !0);
}
var Jt = [];
for (let e = 0; e < 256; e++) Jt.push(0);
...
function Yt(e, t) {
  ...
  if (!t) {
    ...
    (i < 256 && Jt[i] !== 0 ? (t.content = a) : (t.content = o),
      (t.markup = o),
      (t.info = `escape`));
  }
  return ((e.pos = n + 1), !0);
...
function $t(e) {
  ...
  Qt(e, e.delimiters);
  for (let r = 0; r < n; r++) t[r] && t[r].delimiters && Qt(e, t[r].delimiters);
}
var en = { tokenize: Zt, postProcess: $t };
function tn(e, t) {
  let n = e.pos,
    r = e.src.charCodeAt(n);
...
function rn(e) {
  let t = e.tokens_meta,
    n = e.tokens_meta.length;
  nn(e, e.delimiters);
  for (let r = 0; r < n; r++) t[r] && t[r].delimiters && nn(e, t[r].delimiters);
}
var an = { tokenize: tn, postProcess: rn };
function on(e, t) {
  let n,
    r,
    i,
  ...
  if (m < d && e.src.charCodeAt(m) === 40) {
    for (
      l = !1, m++;
      m < d && ((n = e.src.charCodeAt(m)), !(!A(n) && n !== 10));
      m++
    );
    if (m >= d) return !1;
    if (
      ((c = m),
      (i = e.md.helpers.parseLinkDestination(e.src, m, e.posMax)),
      i.ok)
    ) {
      for (
        o = e.md.normalizeLink(i.str),
          e.md.validateLink(o) ? (m = i.pos) : (o = ``),
          c = m;
        m < d && ((n = e.src.charCodeAt(m)), !(!A(n) && n !== 10));
        m++
      );
      if (
        ((i = e.md.helpers.parseLinkTitle(e.src, m, e.posMax)),
        m < d && c !== m && i.ok)
      )
        for (
          s = i.str, m = i.pos;
...
function sn(e, t) {
  ...
  if (((a = m + 1), a < f && e.src.charCodeAt(a) === 40)) {
    for (a++; a < f && ((n = e.src.charCodeAt(a)), !(!A(n) && n !== 10)); a++);
    if (a >= f) return !1;
    for (
      l = a,
        s = e.md.helpers.parseLinkDestination(e.src, a, e.posMax),
        s.ok &&
          ((u = e.md.normalizeLink(s.str)),
          e.md.validateLink(u) ? (a = s.pos) : (u = ``)),
        l = a;
      a < f && ((n = e.src.charCodeAt(a)), !(!A(n) && n !== 10));
      a++
    );
    if (
      ((s = e.md.helpers.parseLinkTitle(e.src, a, e.posMax)),
      a < f && l !== a && s.ok)
    )
      for (
        c = s.str, a = s.pos;
...
var cn =
  ...
  ln = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
function un(e, t) {
  let n = e.pos;
...
function mn(e, t) {
  ...
  let a = e.src.slice(r).match(Lt);
  if (!a) return !1;
  if (!t) {
    let t = e.push(`html_inline`, ``, 0);
    ((t.content = a[0]),
      dn(t.content) && e.linkLevel++,
      fn(t.content) && e.linkLevel--);
  }
  return ((e.pos += a[0].length), !0);
}
var hn = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
  gn = /^&([a-z][a-z0-9]{1,31});/i;
function _n(e, t) {
  let n = e.pos,
    r = e.posMax;
...
function yn(e) {
  let t = e.tokens_meta,
    n = e.tokens_meta.length;
  vn(e.delimiters);
  for (let e = 0; e < n; e++) t[e] && t[e].delimiters && vn(t[e].delimiters);
}
function bn(e) {
  let t,
    n,
...
function W() {
  this.ruler = new I();
  for (let e = 0; e < xn.length; e++) this.ruler.push(xn[e][0], xn[e][1]);
  this.ruler2 = new I();
  for (let e = 0; e < Sn.length; e++) this.ruler2.push(Sn[e][0], Sn[e][1]);
}
((W.prototype.skipToken = function (e) {
  let t = e.pos,
  ...
  (W.prototype.parse = function (e, t, n, r) {
    let i = new this.State(e, t, n, r);
    this.tokenize(i);
...
function K(e) {
  let t = (e.re = Cn(e.__opts__)),
    n = e.__tlds__.slice();
  (e.onCompile(),
    e.__tlds_replaced__ || n.push(Nn),
    n.push(t.src_xn),
    (t.src_tlds = n.join(`|`)));
  function r(e) {
  ...
  ((t.email_fuzzy = RegExp(r(t.tpl_email_fuzzy), `i`)),
    (t.email_fuzzy_global = RegExp(r(t.tpl_email_fuzzy), `ig`)),
    (t.link_fuzzy = RegExp(r(t.tpl_link_fuzzy), `i`)),
    (t.link_fuzzy_global = RegExp(r(t.tpl_link_fuzzy), `ig`)),
    (t.link_no_ip_fuzzy = RegExp(r(t.tpl_link_no_ip_fuzzy), `i`)),
    (t.link_no_ip_fuzzy_global = RegExp(r(t.tpl_link_no_ip_fuzzy), `ig`)),
  ...
  (Object.keys(e.__schemas__).forEach(function (t) {
    ...
    if (((e.__compiled__[t] = r), En(n))) {
      (Dn(n.validate)
        ? (r.validate = Fn(n.validate))
        : On(n.validate)
    ...
    (e.__compiled__[``] = { validate: null, normalize: In() }));
...
function q(e, t) {
  ...
  (t || (jn(e) && ((t = e), (e = {}))),
    (this.__opts__ = wn({}, An, t)),
    (this.__schemas__ = wn({}, Mn, e)),
    (this.__compiled__ = {}),
    (this.__tlds__ = Pn),
...
((q.prototype.add = function (e, t) {
  ...
  (q.prototype.test = function (e) {
    ...
    if (this.re.schema_test.test(e)) {
      for (
        n = this.re.schema_search, n.lastIndex = 0;
        (t = n.exec(e)) !== null;
      )
    ...
    return !!(
      ...
      (this.__opts__.fuzzyEmail &&
        ...
        e.indexOf(`@`) >= 0 &&
        e.match(this.re.email_fuzzy) !== null)
    );
  }),
  ...
  (q.prototype.match = function (e) {
    ...
    if (this.re.schema_test.test(e))
      for (
        ...
        ((o = this.testSchemaAt(e, a[2], s.lastIndex)),
          o &&
            n.push({
              schema: a[2],
    ...
    if (this.__opts__.fuzzyLink && this.__compiled__[`http:`])
      for (
        s = this.__opts__.fuzzyIP
          ? this.re.link_fuzzy_global
          : this.re.link_no_ip_fuzzy_global,
          s.lastIndex = 0;
        (a = s.exec(e)) !== null;
      )
        r.push({
    ...
    if (this.__opts__.fuzzyEmail && this.__compiled__[`mailto:`])
      for (
        s = this.re.email_fuzzy_global, s.lastIndex = 0;
        (a = s.exec(e)) !== null;
      )
        i.push({
          schema: `mailto:`,
    ...
    let l = [0, 0, 0],
      u = 0;
    for (;;) {
      let a = [n[l[0]], i[l[1]], r[l[2]]],
        o = c(c(a[0], a[1]), a[2]);
      if (!o) break;
      if ((o === a[0] ? l[0]++ : o === a[1] ? l[1]++ : l[2]++, o.index < u))
        continue;
      let s = new Ln(e, o.schema, o.index, o.lastIndex);
      (this.__compiled__[s.schema].normalize(s, this),
        t.push(s),
        (u = o.lastIndex));
    }
  ...
  (q.prototype.matchAtStart = function (e) {
    ...
    if (!n) return null;
    let r = new Ln(e, t[2], t.index + t[1].length, t.index + t[0].length + n);
...
function Zn(e, t) {
  let n = e.split(`@`),
    r = ``;
  (n.length > 1 && ((r = n[0] + `@`), (e = n[1])), (e = e.replace(Kn, `.`)));
  let i = Xn(e.split(`.`), t).join(`.`);
  return r + i;
}
function Qn(e) {
  let t = [],
...
var $n = (e) => String.fromCodePoint(...e),
  er = function (e) {
    return e >= 48 && e < 58
      ? 26 + (e - 48)
      : e >= 65 && e < 91
  ...
  nr = function (e, t, n) {
    let r = 0;
    for (e = n ? Z(e / Bn) : e >> 1, e += Z(e / t); e > 455; r += Y)
      e = Z(e / Jn);
  ...
  rr = function (e) {
    ...
    o < 0 && (o = 0);
    for (let n = 0; n < o; ++n)
      (e.charCodeAt(n) >= 128 && Q(`not-basic`), t.push(e.charCodeAt(n)));
    for (let s = o > 0 ? o + 1 : 0; s < n; ) {
      let o = r;
      for (let t = 1, i = Y; ; i += Y) {
        s >= n && Q(`invalid-input`);
        let o = er(e.charCodeAt(s++));
        (o >= Y && Q(`invalid-input`),
          o > Z((J - r) / t) && Q(`overflow`),
          (r += o * t));
        let c = i <= a ? Rn : i >= a + X ? X : i - a;
        if (o < c) break;
        let l = Y - c;
  ...
  ir = function (e) {
    ...
    let n = e.length,
      ...
      i = 0,
      a = Vn;
    for (let n of e) n < 128 && t.push(Yn(n));
    let o = t.length,
      s = o;
    for (o && t.push(Un); s < n; ) {
      let n = J;
      ...
      for (let n of e)
        if ((n < r && ++i > J && Q(`overflow`), n === r)) {
          let e = i;
          for (let n = Y; ; n += Y) {
            let r = n <= a ? Rn : n >= a + X ? X : n - a;
            if (e < r) break;
            let i = e - r,
              o = Y - r;
            (t.push(Yn(tr(r + (i % o), 0))), (e = Z(i / o)));
          }
          (t.push(Yn(tr(e, 0))), (a = nr(i, c, s === o)), (i = 0), ++s);
        }
      (++i, ++r);
    }
    return t.join(``);
  ...
  ar = {
    version: `2.3.1`,
    ucs2: { decode: Qn, encode: $n },
    decode: rr,
    encode: ir,
    toASCII: function (e) {
      return Zn(e, function (e) {
        return Gn.test(e) ? `xn--` + ir(e) : e;
      });
    },
    toUnicode: function (e) {
      return Zn(e, function (e) {
        return Wn.test(e) ? rr(e.slice(4).toLowerCase()) : e;
      });
    },
  },
  or = {
  ...
  sr = /^(vbscript|javascript|file|data):/,
  cr = /^data:image\/(gif|png|jpeg|webp);/;
function lr(e) {
  let t = e.trim().toLowerCase();
  return sr.test(t) ? cr.test(t) : !0;
}
var ur = [`http:`, `https:`, `mailto:`];
function dr(e) {
  let t = b(e, !0);
  if (t.hostname && (!t.protocol || ur.indexOf(t.protocol) >= 0))
    try {
...
function fr(e) {
  ...
  return a(l(t), a.defaultChars + `%`);
}
function $(e, t) {
  if (!(this instanceof $)) return new $(e, t);
  (t || Ee(e) || ((t = e || {}), (e = `default`)),
    (this.inline = new W()),
    (this.block = new H()),
    (this.core = new St()),
    (this.renderer = new F()),
    (this.linkify = new q()),
    (this.validateLink = lr),
    (this.normalizeLink = dr),
    (this.normalizeLinkText = fr),
    (this.utils = we),
    (this.helpers = E({}, Xe)),
    (this.options = {}),
    this.configure(e),
...
var hr = new $({ html: !1, linkify: !0 });
((hr.renderer.rules.heading_open = function (e, t) {
  let n = e[t].markup.length,
    r = e[t + 1];
  return r && r.type === `inline` ? `<h${n} id="${mr(r.content)}">` : `<h${n}>`;
}),
  (hr.renderer.rules.link_open = function (e, t, n, r, i) {
    let a = e[t],
      o = a.attrGet(`href`);
    return (
      o &&
        (o.startsWith(`http://`) || o.startsWith(`https://`)) &&
        (a.attrSet(`rel`, `nofollow noopener`), a.attrSet(`target`, `_blank`)),
      i.renderToken(e, t, n)
    );
  }));
var gr = n(
...
function _r({ content: e, className: t }) {
  let r = e ? hr.render(e) : ``;
  return (0, pr.jsx)(`div`, {
    className: n(gr, t),
